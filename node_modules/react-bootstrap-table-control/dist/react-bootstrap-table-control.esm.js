...
import { Placeholder, Row, Col, Table } from 'react-bootstrap';
...
var TotalItems = function TotalItems(_ref) {
  ...
  }, React.createElement("b", null, "Total:")), !isLoading ? React.createElement("div", null, total) : React.createElement(Placeholder, {
    as: "div",
    style: {
      minWidth: '40px'
    },
...
var SortDirection = function SortDirection(_ref) {
  var column = _ref.column,
    sort = _ref.sort;
  return sort && sort.column === column ? sort.direction === "ASC" ? React.createElement(BsFillCaretDownFill, null) : sort.direction === "DESC" ? React.createElement(BsFillCaretUpFill, null) : React.createElement(React.Fragment, null) : React.createElement(React.Fragment, null);
};
...
var TableControl = function TableControl(_ref) {
  ...
  return React.createElement(React.Fragment, null, (totalPosition === "both" || totalPosition === "top") && React.createElement(Row, null, React.createElement(Col, {
    md: 12,
    className: "mb-3",
    style: {
      display: 'flex',
    ...
    md: 12
  }, React.createElement(Table, Object.assign({}, tableProps), React.createElement(TableHeadControl, {
    header: header,
    sortable: sortable,
  ...
  : React.createElement(TableLoading, {
    ...
    tbodyProps: tbodyProps
  })))), (totalPosition === "both" || totalPosition === "bottom") && React.createElement(Row, null, React.createElement(Col, {
    md: 12,
    className: "mb-3",
    style: {
      display: 'flex',
    ...
    total: total,
    isLoading: isLoading
  }))), !isLoading && pagination && React.createElement(Row, null, React.createElement(Col, {
    md: 12
...
export { TableControl };
//# sourceMappingURL=react-bootstrap-table-control.esm.js.map
